...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2969834729ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=iot&table=login">`iot`.`login`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=iot&table=attendance">`iot`.`attendance`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6c6c64514749735f55364e7d442b7074">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="iot" targettable="login">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `login`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="iot" targettable="attendance">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `attendance`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="iot" targettable="login">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `login` (`id`, `username`, `password`, `usertype`, `Name`, `Status`, `Files`, `StudentNum`) VALUES (NULL, &#039;p09anto&#039;, &#039;p09anto&#039;, &#039;student&#039;, &#039;Ανδρεας Αντωνοπουλος&#039;, &#039;Declined&#039;, &#039;0&#039;, &#039;175893034754&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="iot" targettable="login">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT StudentNum, Name FROM login WHERE Status=&#039;Approved&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="iot" targettable="login">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT COUNT(Name) FROM `login`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="iot" targettable="login">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT COUNT(Name) FROM `login` WHERE Status=&quot;Approved&quot;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="iot" targettable="login">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT COUNT(Name) FROM `login` WHERE Status=&quot;Declined&quot;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="iot" targettable="attendance">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">UPDATE login SET Status=&#039;Aprroved&#039; WHERE username=&quot;p17kont1&quot;;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="" targettable="">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">UPDATE login SET Status=&#039;Approved&#039; WHERE username = &#039;p17kont1&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="iot" targettable="login">
                            <div class="action_content">
